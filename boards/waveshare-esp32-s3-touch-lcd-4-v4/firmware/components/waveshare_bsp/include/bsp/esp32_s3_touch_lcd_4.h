...
/* Rev 4 splits the former combined SYS_EN/BEE pin into two: SYS_EN powers the
   display rail and must be driven high at reset, BEE_EN drives the beeper and
   is held low to keep it silent. */
...
/* Rev 4 replaces Rev 3's TCA9554 with a Waveshare custom CH32V003 IO
   expander, addressed at 0x24. */
...
/* Square RGB panel with no swap_xy in its driver: rotation declines, and an
   RGB panel has no MADCTL to mirror either. */
